...
var commands = exports.commands = {
	...
	dexsearch: function (target, room, user, connection, cmd, message) {
		...
		var allTiers = {'uber':1, 'ou':1, 'bl':1, 'uu':1, 'bl2':1, 'ru':1, 'bl3':1, 'nu':1, 'bl4':1, 'pu':1, 'nfe':1, 'lc uber':1, 'lc':1, 'cap':1, 'pkf':1};
		// MODIFICADO PARA POKEFABRICA		var allColours = {'green':1, 'red':1, 'blue':1, 'white':1, 'brown':1, 'yellow':1, 'purple':1, 'pink':1, 'gray':1, 'black':1};
		...
		for (var pokemon in Tools.data.Pokedex) {
			...
			// MODIFICADO PARA POKEFABRICA
			if (template.tier !== 'Unreleased' && template.tier !== 'Illegal' && (template.tier !== 'CAP' || (searches['tier'] && searches['tier']['cap'])) && (template.tier !== 'PKF' || (searches['tier'] && searches['tier']['pkf'])) && megaSearchResult) {
				// MODIFICADO PARA POKEFABRICA		
	...
	dexsearchhelp: ["/dexsearch [type], [move], [move], ... - Searches for Pok\u00e9mon that fulfill the selected criteria",
		...
		// MODIFICADO PARA POKEFABRICA
		"Valid tiers are: Uber/OU/BL/UU/BL2/RU/BL3/NU/PU/NFE/LC/CAP/PKF.",
		// MODIFICADO PARA POKEFABRICA
