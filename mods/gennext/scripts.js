exports.BattleScripts = {
	...
	this.modData('Learnsets', 'regirock').learnset.recover = ['5L100'];
		...
		this.modData('Pokedex', 'masquerain').types = ['Water', 'Bug'];
			this.modData('Learnsets', 'masquerain').learnset.thunder = ['5L100'];
				...
				this.modData('Pokedex', 'typhlosion').types = ['Fire', 'Ground'];
						...
						this.modData('Learnsets', 'typhlosion').learnset.zapcannon = ['5L100'];
		...
		this.modData('Learnsets', 'flygon').learnset.quiverdance = ['5L100'];
		this.modData('Learnsets', 'flygon').learnset.hurricane = ['5L100'];
		this.modData('Learnsets', 'flygon').learnset.wish = ['5L100'];
			this.modData('Pokedex', 'grumpig').types = ['Normal', 'Psychic'];
		this.modData('Learnsets', 'grumpig').learnset.slackoff = ['5L100'];
		this.modData('Learnsets', 'grumpig').learnset.bellydrum = ['5L100'];
